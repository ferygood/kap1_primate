...
```{r}
#Judith
k1 <- read.table(paste0(path,"Judith_count/Chimp_Judith_Zeb2_neg_R1_refGenecounts.txt"), sep="\t")
k2 <- read.table(paste0(path,"Judith_2/Chimp_Judith_Zeb2_2_R1.fastq_refGenecounts.txt"), sep="\t")
k3 <- read.table(paste0(path,"Judith_3/Chimp_Judith_Zeb2_3_R1.fastq_refGenecounts.txt"), sep="\t")

#Leo
k4 <- read.table(paste0(path,"Leo_count/Chimp_Leo_Zeb2_neg_R1_refGenecounts.txt"), sep="\t")
k5 <- read.table(paste0(path,"Leo_2/Chimp_Leo_Zeb2_2_R1_refGenecounts.txt"), sep="\t")
k6 <- read.table(paste0(path,"Leo_3/Chimp_Leo_Zeb2_3_R1_refGenecounts.txt"), sep="\t")

#Maryke
k7 <- read.table(paste0(path,"Maryke_count/Chimp_Maryke_Zeb2_neg_R1_refGenecounts.txt"), sep="\t")
k8 <- read.table(paste0(path,"Maryke_2/Chimp_Maryke_Zeb2_2_R1.fastq_refGenecounts.txt"), sep="\t")
k9 <- read.table(paste0(path,"Maryke_3/Chimp_Maryke_Zeb2_3_R1.fastq_refGenecounts.txt"), sep="\t")
