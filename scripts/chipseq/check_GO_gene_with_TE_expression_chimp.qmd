...
```{r}
# load GO genes
go_gene <- read.table("../../tables/chimp_peak_cc.txt", 
                      sep = "\t", 
                      header = TRUE, 
                      quote = "", 
                      fill = TRUE, 
                      stringsAsFactors = FALSE)
go_gene_id <- strsplit(go_gene$geneID, "/")[[1]]
...
# 6. Clean and reorder
corr_result_final <- corr_result[, c("gene_id", "te_ids", "te_coef", "te_pval", "te_fdr", "adj_r_squared")]
